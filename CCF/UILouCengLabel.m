...
-(void)drawRect:(CGRect)rect{
    ...
    UIBezierPath *rectanglePath = [UIBezierPath bezierPathWithRoundedRect: self.bounds byRoundingCorners: corner cornerRadii: CGSizeMake(2, 2)];
